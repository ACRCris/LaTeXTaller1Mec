...
\begin{document}
    ...
    \input{punto1/intro.tex}\\
    \input{punto1/a.tex}
    \input{punto1/solucionA.tex}
    \input{punto1/b.tex}
    \input{punto1/solucionB.tex}
    \input{punto1/intro2.tex}
    \input{punto1/c.tex}
    \input{punto1/solucionC.tex}
    \input{punto1/d.tex}
    \input{punto1/solucionD.tex}
    \input{punto1/e.tex}
    \section{ ¿Qué tan probable es encontrar más moléculas de un gas a 
    un lado que al otro de un salón?}
    \input{punto2/intro.tex}
    \input{punto2/a.tex}
    \input{punto2/solucionA.tex}
    \input{punto2/b.tex}
    \input{punto2/solucionB.tex}
    \input{punto2/c.tex}
    \input{punto2/solucionC.tex}
    \input{punto2/d.tex}
    \input{punto2/solucionD.tex}
    \input{punto2/intro2.tex}\\
    \input{punto2/e.tex}
    \input{punto2/solucionE.tex}
    \input{punto3/intro.tex}
    \input{punto3/a.tex}
    \input{punto3/SolucionA.tex}
    \input{punto3/b.tex}
    \input{punto3/SolucionB.tex}
    \input{punto3/c.tex}
    \input{punto3/SolucionC.tex}
    \input{punto3/d.tex}
    \input{punto3/SolucionD.tex}
    \input{punto3/e.tex}
    \input{punto3/SolucionE.tex}
